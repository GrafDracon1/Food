...
function cards() {
  // Використання класів для карточків
  ...
  Object(_services_services__WEBPACK_IMPORTED_MODULE_5__["getResource"])('http://localhost:3000/menu').then(function (data) {
...
function forms(formSelector, modalTimerId) {
  ...
  var message = {
    ...
    success: 'Дякую! Скоро ми з вами звяжимося',
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('.timer', '2020-08-11');
